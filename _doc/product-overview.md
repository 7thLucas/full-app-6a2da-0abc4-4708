# KYYBOT — Product Overview

## What It Is

KYYBOT is a personal AI assistant app built for a single user who wants their own dedicated AI — comparable to popular AI assistants (ChatGPT, Claude, Gemini) but personally owned and branded.

## Core Purpose

Give the owner a reliable, always-available AI assistant for two primary use cases:
1. **Coding assistance** — write, debug, explain, and review code across languages and frameworks.
2. **General Q&A** — answer questions on any topic, explain concepts, summarize information, and hold open-ended conversations.
